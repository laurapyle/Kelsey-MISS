...
Table 2: Relative Abundance Spearman Correlation with Insulin Sensitivity, FDR Adjusted P-Values
```{r echo=FALSE}
kable(corr.table,row.names = F)
```
...
Table 5: Relative Abundance Spearman Correlation with Insulin Sensitivity, Unadjusted P-Values
```{r echo=FALSE}
kable(corr.table,row.names = F)
```
